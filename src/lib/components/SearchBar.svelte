<div class='w-full'>
	...
	<div class='flex rounded-lg shadow-sm'>
		<input type='text' id='hs-trailing-button-add-on-with-icon' name='hs-trailing-button-add-on-with-icon'
					 class='py-3 px-4 block w-full bg-white border-accent border rounded-l-xl shadow-sm rounded-s-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none placeholder-accent'
					 placeholder='Поиск'>
		<button type='button'
						class='w-[2.875rem] h-[2.875rem] flex-shrink-0 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-e-md border border-accent rounded-r-xl background-accent text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none'>
